...
//		b.method1();
	...
	public void method1() {
		...
		System.out.println(double4); //1.11
		...
		System.out.println(double5); //3.555
	...
	public void method2() {
		...
		System.out.println(str1 + str2); // 103.14 문자열이기때문에계산안되고 그대로
		...
		System.out.println(str3 + str4); //103.14 문자열이니깐~~
