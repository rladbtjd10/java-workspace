...
public class MusicController {
	...
	public Music removeMusic(String title) {
		/*
		 * for(Music music : list) { if(music.getTitle().equals(title)) {
		 * list.remove(music); return music; } } return null;
		 */
		// ---첫번째 방법
	...
	public ArrayList<Music> ascTitle() {
		ArrayList<Music> list = (ArrayList<Music>) this.list.clone(); // (ArrayList<Music>)넣어준거 형변환 해준거임
		// 오름차순
