 ...
 * - 람다식을 사용하면 코드는 간결해지고 컬렉션의 요소들을 필터링하거나 매핑해서 원하는 결과를 쉽게 가져올 수 있음
 * 
...
public class Application {
	...
	public static void main(String[] args) {
		...
		MathInterface plusLambda = (int x, int y) -> {return x + y;};  //여러줄일때 {},return붙임
		MathInterface minusLambda = (int x, int y) -> x - y; // 한줄일때는 그냥 {},return 없이 써도됨
