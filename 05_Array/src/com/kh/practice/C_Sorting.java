...
public class C_Sorting {
	...
	public void method1() {
		...
		Arrays.sort(arr); // DualPivotQuicksort <- Ctrl + 마우스로 sort 가져다 대고 누르면 
	 ...
	 * - 데이터 양이 적을 때 좋음! 하지만 100 이상의 자료에서는 급격한 속도 저하
	 * 
	 * 7, 5, 9, 0, 3, 1, 6, 2, 4, 8
	 * 0, 5, 9, 7, 3, 1, 6, 2, 4, 8
	 * 0, 1, 9, 7, 3, 5, 6, 2, 4, 8
	...
	public void method5() {
		...
		/*
		 * 버블 정렬(BUubble sort)
		 * - 인접한 두수를 비교해서 큰 수를 뒤로 보내는 것이 특징
		 * - 구현이 쉽다는 장점이 있지만, 다른 정렬에 비래 속도가 느리며, 역순으로 정렬할 때 가장 느린 속도를 가짐
		 * 
		 * 7,5,9,0,3,1,6,2,4,8
		 * 5,7,0,3,1,6,2,4,8,9
		 * 5,0,3,1,6,2,4,7,8,9
