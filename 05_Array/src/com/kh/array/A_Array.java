...
//		System.out.print(score); //[I@3d012ddd
	
		/*
		 * - 배열을 생성하고 초기화 해주지 않아도 문제없이 출력!
		 * - JVM이 지정한 기본값으로 배열이 초기화
		 * (정수형 : 0, 실수형 0.0, 문자형 : \u0000,', 논리형 : false, 초기화 주 값 : 100
	...
	public void method2(){
		...
		//int[] score2;
		//score2 = new int[] {100, 90, 80, 70, 60}; // 이건 안됨!(둘로나누면안됨)
	...
	public void method3(){
		...
		for(int i=0; i<score.length; i++) {
			 ...
			 * - 증감식을 사용하지 않고 배열 및 컬렉션 요소 개수만큼 반복하고 for문을 종료
			 */
	...
	public void method5(){
		...
		System.out.println(Arrays.toString(number)); // 기존에 있던것도 바뀜!
		System.out.println(Arrays.toString(copy)); 
	...
	public void method6(){	
		...
		System.out.println(Arrays.toString(number)); // 기존에 있던거는 안바뀜!
		System.out.println(Arrays.toString(copy));
	...
	public void method8(){
		...
		//System.out.println(copy.length); // NullPointerException 에러가 남
