...
public class B_inDecrease {
	 ...
	 * 
	 * - 값(증감 연산자) : 후위 연산으로 먼저 다른 연산을 수행하고 증감 연산을 수행 (연산이 전부 끝나고 증가함 즉 결과값에 영향x)                        
	 */
	...
	//전위 연산자
		...
		System.out.println("1회 수행 후 값 : " + ++number); // 11, number에 더하기 1을 한 값과 같음
