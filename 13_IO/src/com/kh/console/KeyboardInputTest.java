...
public class KeyboardInputTest {
	...
	//키보드로 데이터를 읽어들여서 콜솔로 출력하는 로직
	public static void main(String[] args) {
		//1. 스트림 생성 : 입력 스트림만 필요
		InputStreamReader ir = new InputStreamReader(System.in); // 기반 스트림  //그냥알아만둠 거의쓰지않음
		BufferedReader br = new BufferedReader(ir); //보조 스트림 //그냥알아만둠 거의쓰지않음
